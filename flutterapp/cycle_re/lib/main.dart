            ...
            onChanged: (bool newValue) {
              Navigator.push(
                ...
                new MaterialPageRoute(
                    builder: (ctxt) =>
                        new UploadTester(title: 'Flutter Demo Home Page')),
              );
            }));
  }
}
...
class UploadTester extends StatefulWidget {
  UploadTester({Key key, this.title}) : super(key: key);
  ...
  @override
  _UploadTester createState() => _UploadTester();
}

class _UploadTester extends State<UploadTester> {
